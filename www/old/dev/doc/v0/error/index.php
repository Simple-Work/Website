...
<html lang="fr">
    <head>
        <title>Développeur - Documentation PHP - simple-work.tk</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="w3-container w3-blue w3-center w3-padding-64">
            <h1 class="w3-margin w3-jumbo"><i class="fa fa-times-circle-o"></i> Documentation des erreurs</h1>
        </div>
        ...
        <div class="w3-row-padding w3-center w3-margin-top">
            <div class="w3-quarter">
                <div id="left-div" class="w3-card-2 w3-padding-top w3-light-grey" style="min-height:1000px">
                    ...
                    <ul class="w3-large" style="text-align: left;list-style-type:none;">
                        <li><span class='w3-tag w3-red'>830xx</span> Erreur générique
                            <ul class="fa-ul">
                                <li><span class='w3-tag w3-red'>83000</span> Erreur inconnu</li>
                                <li><span class='w3-tag w3-red'>83001</span> {{item name}}</li>
                                <li><span class='w3-tag w3-red'>83002</span> {{item name}}</li>
                            </ul>
                        </li>
                        <li><span class='w3-tag w3-red'>831xx</span> {{folder name}}</li>
                        <li><span class='w3-tag w3-red'>832xx</span> {{folder name}}</li>
                        <li><span class='w3-tag w3-red'>833xx</span> {{folder name}}</li>
                        <li><span class='w3-tag w3-red'>834xx</span> {{folder name}}</li>
                    </ul>
                </div>
            </div>
            <div class="w3-half">
                ...
                <div id="right-div" class="w3-card-2 w3-padding-top w3-dark-grey w3-xlarge" style="min-height:1000px">
                    ...
                    <?php
                        if(strpos($info[3],'test') !== false) {
                            echo "<div style='margin: 0 10px;' class='w3-container w3-orange'><h3>Cette erreur est actuellement en test</h3><p class='w3-large'>".$info[4]."</p></div>";
                        }
                        elseif(strpos($info[3],'ok') !== false) {
                            echo "<div style='margin: 0 10px;' class='w3-container w3-green'><h3>Cette erreur fonctionne parfaitement</h3><p class='w3-large'>".$info[4]."</p></div>";
                        }
                        elseif(strpos($info[3],'abandon') !== false) {
                            echo "<div style='margin: 0 10px;' class='w3-container w3-orange'><h3>Cette erreur est à l'abandon</h3><p class='w3-large'>".$info[4]."</p></div>";
                        }
                        elseif(strpos($info[3],'replaced') !== false) {
                            echo "<div style='margin: 0 10px;' class='w3-container w3-orange'><h3>Cette erreur à était remplacé</h3><p class='w3-large'>".$info[4]."</p></div>";
                        }
                        elseif(strpos($info[3],'deleted') !== false) {
                            echo "<div style='margin: 0 10px;' class='w3-container w3-red'><h3>Cette erreur est supprimé</h3><p class='w3-large'>".$info[4]."</p></div>";
                        }
                        else {
                            echo "<div style='margin: 0 10px;' class='w3-container w3-blue'><h3>Cette erreur n'a pas de status particulière</h3><p class='w3-large'>".$info[4]."</p></div>";
                        }
                        ...
                        if($errors[0] !== "") {
                            ...
                            foreach ($errors as $error) {
                                $item = explode("§", $error);
                                echo "<li><a href='http://www.simple-work.tk/dev/doc/error/?code=".$item[0]."'><code>".$item[0]."</code> ".$item[1]."</a></li><br/>";
                            }
                            echo "</ul>";
                        }
                    ?>
